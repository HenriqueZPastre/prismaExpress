...
CREATE TABLE "new_Lancamentos" (
    ...
    "contasNome" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_Lancamentos" ("contasId", "create_at", "dataPagamento", "dataVencimento", "deletede_at", "descricao", "id", "tipo", "valor") SELECT "contasId", "create_at", "dataPagamento", "dataVencimento", "deletede_at", "descricao", "id", "tipo", "valor" FROM "Lancamentos";
